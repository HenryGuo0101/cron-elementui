      ...
      <div class="left">
        <el-tabs size="small" v-model="curtab" style="font-size: 8px;">
          ...
          <el-tab-pane label="Week" name="week">
            <span slot="label"><i class="el-icon-date"></i>Week</span>
      ...
      <div class="right">
        ...
        <div class="exe-pre">
          <div class="exe-pre-panel">
            <label class="p-left">Exec Date:</label>
...
<script>
  ...
  export default {
    ...
    computed: {
      tableData() {
        let c = this.hideSecond ? [] : [{name: 'Seconds', value: this.second}]
        c = c.concat([
          {name: 'Minutes', value: this.minute},
          {name: 'Hours', value: this.hour},
          {name: 'Day', value: this.day},
