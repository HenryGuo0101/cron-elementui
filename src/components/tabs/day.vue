<template>
  <div class="config-list">
    <el-radio-group v-model="type" style="font-size: 12px">
      <div class="item">
        <el-radio label="TYPE_NOT_SET" class="choice" :disabled="disableChoice" size="mini" :border="true">Not Set
        </el-radio>
        <span class="tip-info">Day Or Week can only choose one</span>
      </div>
      <div class="item">
        <el-radio label="TYPE_EVERY" class="choice" :disabled="disableChoice" size="mini" :border="true">Every Day
        </el-radio>
      </div>
      <div class="item">
        <el-radio label="TYPE_RANGE" class="choice" :disabled="disableChoice" size="mini" :border="true"
                  style="margin-right: 15px">Range
        </el-radio>
        From
      ...
      <div class="item">
        <el-radio label="TYPE_WORK" class="choice" :disabled="disableChoice" size="mini" :border="true"
                  style="margin-right: 3px">Workday
        </el-radio>
        This month
      ...
      <div class="item">
        <el-radio label="TYPE_LAST" class="choice" :disabled="disableChoice" size="mini" :border="true">On the last day
          of month
        </el-radio>
      </div>
      <div class="item">
